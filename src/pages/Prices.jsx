...
const Prices = () => {
  ...
  const pricingTables = [
    <PricingTable key={0} name="normalna" active={day !== 6 && day !== 0} />,
    <PricingTable key={1} name="weekendowa" active={day === 6 || day === 0} />,
    <PricingTable key={2} name="wakacyjna" active={today > startDate && today < endDate} />,
